...
public class LockController {
    ...
    public UnlockResponseDTO unlock(@RequestParam String passcode) {
        smartLockService.unlock(passcode);
        return new UnlockResponseDTO("Door unlocked");
    }


    // @PostMapping("/check-battery")
    // public UnlockResponseDTO checkBattery() {
    //     smartLockService.checkBattery();
    //     return new UnlockResponseDTO("Battery checked");
    // }
